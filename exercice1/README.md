...
## Installation de Spark 1.3

* Télécharger une version pré-compilée d'Apache Spark 1.3 [ici](http://www.eu.apache.org/dist/spark/spark-1.3.0/spark-1.3.0-bin-hadoop2.4.tgz) (~ 245 Mo).
...
Lancer la commande `/path/to/spark/bin/spark-shell` dans un terminal depuis le répertoire "exercice1".
